...
|---|---|---|---|---|---|---|---|---|
| DBZ-014 | Devbiz | #20 | `claude/ai-code-review-learning-q4ouka` | docs | `AWAITING_AUDIT` | Owner review/merge of the Code Lens spec | Review & merge PR #20; then greenlight Phase 2 scaffold as a separate PR | Code Lens spec. Owner approved directionally 2026-06-18: name=Code Lens; Phase 2 = deterministic read-only scaffold (no writes/auto-fix/merge); AI deferred behind a provider interface; score advisory (90/75 bands). Spec/plan only — no tool code. See `docs/code-lens-plan.md`. |
