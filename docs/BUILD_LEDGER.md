...
|---|---|---|---|---|---|---|---|---|
| DBZ-028 | Devbiz | TBD | `claude/ledger-backfill-reconcile` | docs | `DRAFT` | Owner review of docs | Review & merge the backfill PR | Second reconciliation: backfills `MERGED` rows DBZ-020..027 for the merged batch, updates spec-doc gating text (PR #20 merged), renames Focus-Board working IDs `DBZ-00x` -> `CP-00x` to end the ledger collision, and resolves the `prs.json` "this PR" placeholder to #25. Process/data-only. |
