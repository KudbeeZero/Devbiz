...
|---|---|---|---|---|---|---|---|---|
| DBZ-019 | Devbiz | TBD | `claude/ledger-cleanup-merged` | docs | `DRAFT` | Owner review of docs | Review & merge the cleanup PR | Post-merge reconciliation: flips DBZ-017/DBZ-018 to `MERGED` and clears stale "draft/pending/merge-me" references for the just-merged PRs (#14, #20, #29, #30, #31, #32, #34, #37, #38, #41) across the Mission Control data files. Process-only. |
