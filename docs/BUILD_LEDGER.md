...
| DBZ-079 | Devbiz | — | `cursor/pinball-launch-reserve-2a63` | bugfix | `BUILDING` | `npm run pinball:eval` **24/24** | Review / merge | **Pinball playability:** failed plunges re-park; mid-charge crest without prepBall; lane-C inset; right mini-flip pocket eject. Local passed, no CI configured. |
