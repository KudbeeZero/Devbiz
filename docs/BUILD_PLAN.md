...
| # | ID | Item | Lane | Status |
|---|----|------|------|--------|
| 0 | DBZ-036 | This plan doc + ledger catch-up | docs | ☐ in progress |
| 1 | DBZ-037 | **W1** Honest social proof — reframe unverified "150+/50+/98%" stats + named testimonials to defensible claims | content | ☐ todo |
